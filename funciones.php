...
function guardar_historial($id_producto,$fecha,$reference,$quantity){
	global $con;
	$sql="INSERT INTO historial (id_historial, id_producto, fecha,  referencia, cantidad)
	VALUES (NULL, '$id_producto',  '$fecha',  '$reference', '$quantity');";
