              ...
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/stock.png" alt=""> 
				  <br>
					...
					<a href="#myModal2" data-toggle="modal" data-codigo='<?php echo $row['codigo_producto'];?>' data-codigobarra='<?php echo $row['codigo_barra'];?>' data-nombre='<?php echo $row['nombre_producto'];?>' data-fabricante='<?php echo $row['id_fabricante']?>' data-precio='<?php echo $row['precio_producto']?>' data-stock='<?php echo $row['stock'];?>' data-id='<?php echo $row['id_producto'];?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editar </a>	
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12 margin-btm-10">
					 ...
					 <div class="col-sm-12 margin-btm-10">
                      <span class="item-number"><?php echo $row['codigo_barra'];?></span>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
                    <div class="col-sm-12">
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	$('#myModal2').on('show.bs.modal', function (event) {
		...
		var codigobarra = button.data('codigobarra') 
		...
		modal.find('.modal-body #mod_codigobarra').val(codigobarra)
