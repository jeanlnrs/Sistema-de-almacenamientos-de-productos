<?php
	if (empty($_POST['mod_id'])) {
		...
		} else if ($_POST['mod_fabricante']==""){
			$errors[] = "Selecciona el Fabricante";
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."',codigo_barra='".$codigobarra."', nombre_producto='".$nombre."', id_fabricante='".$fabricante."', precio_producto='".$precio_venta."', stock='".$stock."' WHERE id_producto='".$id_producto."'";
